...
#include "sm/Contact/ActiveBc/node2segmentpenaltycontact2.h"
#include "set.h"
#include "domain.h"
#include "node.h"
...
void
Node2SegmentPenaltyContact::computeNormalMatrixAt(FloatArray & answer, Node * node, ContactSegment * segment, TimeStep * tStep)
{
