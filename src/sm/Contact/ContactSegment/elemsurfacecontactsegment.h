...
namespace oofem {
    class Linear3dElementSurfaceContactSegment : public BoundaryContactSegment
    {
    public:
        Linear3dElementSurfaceContactSegment(int n, Domain *aDomain) : BoundaryContactSegment(n, aDomain) { ; }
        ~Linear3dElementSurfaceContactSegment() {};
